...
const supplementalTranslations: TranslationMap = {
  id: {
    ...
    "SECTION 1 · PERSONALITY": "BAGIAN 1 · KEPRIBADIAN",
    "SECTION 2 · JOB FIT": "BAGIAN 2 · KESESUAIAN POSISI",
    "SECTION 3 · DECISION SUPPORT": "BAGIAN 3 · DUKUNGAN KEPUTUSAN",
  ...
  es: {
    ...
    "SECTION 1 · PERSONALITY": "SECCIÓN 1 · PERSONALIDAD",
    "SECTION 2 · JOB FIT": "SECCIÓN 2 · COMPATIBILIDAD",
    "SECTION 3 · DECISION SUPPORT": "SECCIÓN 3 · APOYO A LA DECISIÓN",
  ...
  "zh-CN": {
    ...
    "SECTION 1 · PERSONALITY": "第1部分 · 个性特征", "SECTION 2 · JOB FIT": "第2部分 · 岗位匹配", "SECTION 3 · DECISION SUPPORT": "第3部分 · 决策支持",
  ...
  "zh-TW": {
    ...
    "SECTION 1 · PERSONALITY": "第1部分 · 個性特徵", "SECTION 2 · JOB FIT": "第2部分 · 職位匹配", "SECTION 3 · DECISION SUPPORT": "第3部分 · 決策支援",
